    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cert_required', models.BooleanField(blank=True, default=False, help_text='인증 필수 여부')),
                ('cert_detail', models.TextField(blank=True, help_text='인증 상세', null=True)),
                ...
                ('closing_date', models.DateTimeField(default=None, help_text='종료 시점', null=True)),
                ('penalty_bank', models.PositiveIntegerField(default=0, help_text='벌금의 합')),
                ('activity_tags', models.ManyToManyField(default=None, help_text='활동 태그', to='goals.activitytag')),
            ],
        ),
    ]
