...
schema_view = get_schema_view(
   openapi.Info(
      title="Fever Partners API",
      default_version='v1',
      description="Fever Partners API Test",
      terms_of_service="https://github.com/hbam1/django_back",
      contact=openapi.Contact(email="hbbaamm@gmail.com"),
   ),
   public=True,
